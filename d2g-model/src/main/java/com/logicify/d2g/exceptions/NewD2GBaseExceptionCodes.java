...
public enum NewD2GBaseExceptionCodes {
    ...
    USER_NOT_FIND(21, "User with this email was not found"),
    ...
    INVALID_DATE_FORMAT(29, "Invalid date format. Please specify as dd/mm/yyyy"),
    ...
    TRANSACTION_DATE_REQUIRED(33, "Transaction date is required"),
    PRODUCT_NAME_REQUIRED(34, "Product name is required"),
    CATEGORY_REQUIRED(35, "Category is required"),
    UNIT_PRICE_REQUIRED(36, "Unit price is required"),
    INVALID_PRODUCT_NAME(37, "Product name should not be less than 3 characters and more than 32 characters. It can contain: a-z, A-Z, 0-9, spaces, symbols (e.g. -=[]\\;,./~#№$%&*()_+:)"),
    INVALID_STORE_NAME(38, "Store location should not be less than 3 characters and more than 256 characters. It can contain: a-z, A-Z, 0-9, spaces, symbols (e.g. -=[]\\;,./~#№$%&*()_+:)"),
